...
A premium, developer-friendly reference for the FinSight backend.

- Base URL (production): `https://FinSight.onrender.com`
- Base Path: `/api`
- Version: 1.0
...
FinSight is an AI‑powered personal finance backend that enables:
...
| FRONTEND_ORIGIN | yes | Allowed CORS origin (frontend) | `https://FinSight.netlify.app` |
